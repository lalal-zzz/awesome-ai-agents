...
## [mcp-skill-deployer](https://github.com/lalal-zzz/mcp-skill-publisher)
One-stop MCP & Skill quality auditor, optimizer, and multi-platform publisher

<details>

### Category
Coding, Developer Tools, DevOps, Publishing

### Description
- mcp-skill-deployer is a universal AI Agent Skill that automates the complete publishing pipeline for MCP servers and Agent Skills across 9 platforms: NPM, Smithery.ai, Anthropic Registry, GitHub, cursor.directory, Dify, GPT Store, Coze, FlowGPT, and PromptBase.
- Features: compliance audit, 100-point quality scoring, guided optimization, multi-platform export, security checks, and per-step confirmed publishing.

### Links
- [GitHub](https://github.com/lalal-zzz/mcp-skill-publisher)
- [Install](https://github.com/lalal-zzz/mcp-skill-publisher#install)
